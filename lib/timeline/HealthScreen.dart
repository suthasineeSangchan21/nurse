...
class HealthScreen extends StatefulWidget {
  ...
  HealthScreen(this.id, this.timeLineBloc);
  @override
...
class _HealthScreenState extends State<HealthScreen> {
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.access_time,
                            color: AppColor.colorFont, size: 16),
                        SizedBox(
                          width: 10,
                        ),
                        Card(
  ...
  _contentView(setState) {
    return Column(
        ...
        children: [
          ...
          _inputView('น้ำหนัก', true, timeLineBloc.controllerWeight, '', 70.0,
              "ก.ก.", "", Colors.black, setState),
          _inputView('ส่วนสูง', true, timeLineBloc.controllerTall, '', 70.0,
              "ซ.ม.", "", Colors.black, setState),
          _inputView('อุณหภูมิ', true, timeLineBloc.controllerTemp, '38', 70.0,
              "°C", 'ตัวร้อน', Colors.red, setState),
          _inputView('ชีพจร', true, timeLineBloc.controllerHearthless1, '120',
              70.0, "ครั้ง/นาที", 'ปกติ', Colors.red, setState),
          _inputView('การหายใจ', true, timeLineBloc.controllerBeat1, '120',
              70.0, "ครั้ง/นาที", 'ปกติ', Colors.red, setState),
          _inputViewColumn(
              'ความดันโลหิต',
              true,
          ...
          _inputView('ระดับออกซิเจนในเลือด', true, timeLineBloc.controllerO2,
              '', 200.0, "%", "ปกติ", Colors.green, setState),
          SizedBox(
            height: 20,
          ),
        ]);
  ...
  _inputViewColumn(text, isEdit, controller1, controller2, hint1, hint2, width,
      unit, remark, colorRemark, setState) {
    return Column(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                      ...
                      : Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: controller1.text == "" && isValidate
                                        ? Colors.red
                                        : Colors.grey),
                      ...
                      : Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: controller2.text == "" && isValidate
                                        ? Colors.red
                                        : Colors.grey),
                                borderRadius: BorderRadius.circular(6.0),
                              ),
  ...
  _inputView(text, isEdit, controller, hint, width, unit, remark, colorRemark,
      setState) {
    return Container(
        width: MediaQuery.of(context).size.width * 0.8,
                      ...
                      : Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: controller.text == "" && isValidate
                                        ? Colors.red
                                        : Colors.grey),
                                borderRadius: BorderRadius.circular(6.0),
                              ),
