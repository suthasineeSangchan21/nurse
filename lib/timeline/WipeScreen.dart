...
class WipeScreen extends StatefulWidget {
  ...
  WipeScreen(this.id, this.timeLineBloc);
  @override
                  ...
                  Row(
                      ...
                      children: [
                        _radioButtonView(
                            TimeLineBloc.smell,
                            "มีแผลกดทับหรือไม่ ?",
                            timeLineBloc.woundController,
                            setState,
                            120.0)
                      ]),
                  timeLineBloc.woundController.text == "มี"
                      ? Column(children: [
                          Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text(
                                  "รายละเอียดแผล",
                                  style: TextStyle(
                                      color: AppColor.colorFont, fontSize: 12),
                                ),
                                SizedBox(
                                  width: 5,
                                ),
                          ...
                          Column(
                              ...
                              children: [
                                ...
                                _dropdownViewPrefix(
                                    timeLineBloc.dataPainDropdown,
                                    setState,
                                    timeLineBloc.woundDetailController)
                              ]),
                          SizedBox(
                            height: 15,
                          ),
  ...
  Widget _historyView() {
    return Column(children: [
      ...
      Container(
          ...
          child: Row(
              ...
              children: [
                ...
                Text(
                  timeLineBloc.woundController.text,
                  style: TextStyle(color: Colors.black, fontSize: 14),
                ),
              ])),
      timeLineBloc.woundController.text == "มี"
      ...
      Row(
          ...
          children: [
            Text(
              DateHelper.convertStringCalendarToDayFormat(timeLineBloc.endTime),
              style: TextStyle(color: AppColor.colorFont, fontSize: 14),
            ),
            SizedBox(
              width: 50,
