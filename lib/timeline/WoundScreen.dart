...
class WoundScreen extends StatefulWidget {
  ...
  WoundScreen(this.id, this.timeLineBloc);
  @override
...
class _WoundScreenState extends State<WoundScreen> {
        ...
        child: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  _dropdownViewPrefix(timeLineBloc.dataWoundDropdown, setState,
                      timeLineBloc.woundAreaController),
                  SizedBox(
                    height: 15,
                  ),
                  Text(
                  ...
                  Row(
                      ...
                      children: [
                        Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _checkBoxView(timeLineBloc.checkBoxDataName[0], 0,
                                  setState),
                              _checkBoxView(timeLineBloc.checkBoxDataName[1], 1,
                                  setState),
                              _checkBoxView(timeLineBloc.checkBoxDataName[2], 2,
                                  setState),
                            ])
                      ]),
                  SizedBox(
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: TextField(
                              maxLines: 1,
                              controller: timeLineBloc.woundSizeController,
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          int i = 0;
                          timeLineBloc.woundDetailController.text = "";
                          timeLineBloc.checkBoxData.forEach((element) {
                            if (element) {
                              timeLineBloc.woundDetailController.text =
                                  timeLineBloc.woundDetailController.text +
                                      " " +
                                      timeLineBloc.checkBoxDataName[i];
                            }
                            i++;
                          });
                          timeLineBloc.sendWound();
                          setState(() {
  ...
  Widget _checkBoxView(txt, index, setState) {
    return Container(
        height: 30,
        margin: EdgeInsets.only(left: 10, right: 10),
        child: Row(
          ...
          children: <Widget>[
            Checkbox(
              ...
              value: timeLineBloc.checkBoxData[index],
              onChanged: (bool? value) {
                setState(() {
                  timeLineBloc.checkBoxData[index] = value!;
                });
              },
            ),
            Text(
          ...
          children: [
            Row(
                ...
                children: [
                  ...
                  Text(
                    timeLineBloc.woundAreaController.text,
                    style: TextStyle(color: Colors.black, fontSize: 14),
                  ),
                ]),
            SizedBox(
            ...
            Row(
                ...
                children: [
                  ...
                  Text(
                    timeLineBloc.woundSizeController.text,
                    style: TextStyle(color: Colors.black, fontSize: 14),
                  ),
                  SizedBox(
                    width: 10,
