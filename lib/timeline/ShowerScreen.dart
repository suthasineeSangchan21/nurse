...
class ShowerScreen extends StatefulWidget {
  ...
  ShowerScreen(this.id, this.timeLineBloc);
  @override
...
class _ShowerScreenState extends State<ShowerScreen> {
                ...
                children: [
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        _dropdownViewPrefix(timeLineBloc.dataShowerDropdown,
                            setState, timeLineBloc.showerController),
                        SizedBox(
                          height: 10,
                        ),
                        Text(
                        ...
                        _dropdownViewPrefix(timeLineBloc.dataTeethDropdown,
                            setState, timeLineBloc.blushTeethController)
                      ]),
                  SizedBox(
                    height: 10,
                  ),
                  _radioButtonView(TimeLineBloc.smell, "กลิ่นตัว",
                      timeLineBloc.bodysmellController, setState, 90.0),
                  SizedBox(
                    width: 10,
                  ),
                  Text(
                  ...
                  _dropdownViewPrefix(timeLineBloc.dataTeethDetailDropdown,
                      setState, timeLineBloc.teethDetailController),
                  SizedBox(
                    height: 15,
                  ),
                  Text(
                  ...
                  _dropdownViewPrefix(timeLineBloc.dataSkinDropdown, setState,
                      timeLineBloc.skinController),
                  SizedBox(
                    height: 15,
                  ),
                  _radioButtonView(TimeLineBloc.oval, "ลักษณะเหงือก",
                      timeLineBloc.gumController, setState, 110.0),
                  SizedBox(
                    height: 10,
                  ),
                  Text(
                  ...
                  Container(
                      ...
                      child: TextField(
                        maxLines: 3,
                        controller: timeLineBloc.otherShowerController,
  ...
  Widget _dropdownViewPrefix(data, setState, controller) {
    final mqWidth = MediaQuery.of(context).size.width * 0.4;
    return Row(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.showerController.text,
                              style: TextStyle(fontSize: 14),
                            )
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.bodysmellController.text,
                              style: TextStyle(fontSize: 14),
                            ),
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.skinController.text,
                              style: TextStyle(fontSize: 14),
                            ),
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.blushTeethController.text,
                              style: TextStyle(fontSize: 14),
                            ),
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.teethDetailController.text,
                              style: TextStyle(fontSize: 14),
                            ),
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.gumController.text,
                              style: TextStyle(fontSize: 14),
                            ),
                          ]),
                      SizedBox(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                              timeLineBloc.otherShowerController.text,
                              style: TextStyle(fontSize: 14),
                            )
                          ]),
                      SizedBox(
                          ...
                          Column(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: Text(
                                      DateHelper
                                          .convertStringCalendarToDayFormat(
                                              timeLineBloc.endTime),
                                      style: TextStyle(
                                          color: AppColor.colorFont,
                                          fontSize: 14),
