...
class PhlegmScreen extends StatefulWidget {
  String id;
  TimeLineBloc timeLineBloc;
  PhlegmScreen(this.id, this.timeLineBloc);
  @override
  State<PhlegmScreen> createState() => _PhlegmScreenState();
}

class _PhlegmScreenState extends State<PhlegmScreen> {
        ...
        child: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  _dropdownViewPrefix(timeLineBloc.dataPhlegmDropdown, setState,
                      timeLineBloc.phlegmDetailController),
                  SizedBox(
                    height: 15,
                  ),
                  Text(
                  ...
                  Card(
                      color: AppColor.colorBgBluePopup,
                      shape: RoundedRectangleBorder(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: TextField(
                                          maxLines: 1,
                                          controller:
                                              timeLineBloc.phlegmNextController,
                                          decoration: InputDecoration(
                                            enabledBorder: OutlineInputBorder(
                                              borderSide: BorderSide(
                                                  color: Colors.grey),
              ...
              Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          timeLineBloc.phlegmDetailController.text,
                          style: TextStyle(color: Colors.black, fontSize: 14),
                        ),
                      ])),
              Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  timeLineBloc.phlegmNextController.text,
                                  style: TextStyle(
                                      color: AppColor.colorFont, fontSize: 14),
                                ),
                                SizedBox(
