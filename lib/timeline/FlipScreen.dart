...
class FlipScreen extends StatefulWidget {
  ...
  FlipScreen(this.id, this.timeLineBloc);
  @override
                  ...
                  Text(
                    "บันทึกการพลิกตัว " +
                        DateHelper.convertTimeFormat(timeLineBloc.startTime)
                            .substring(0, 5) +
                        " น.",
                    style: TextStyle(color: AppColor.colorFont, fontSize: 18),
                  ),
                  SizedBox(
                    height: 20,
                  ),
            ...
            Text(
              "บันทึกการพลิกตัว " +
                  DateHelper.convertTimeFormat(timeLineBloc.startTime)
                      .substring(0, 5) +
                  " น.",
              style: TextStyle(color: AppColor.colorFont, fontSize: 20),
            ),
            SizedBox(
              height: 20,
            ),
